...
import { fetchProductByBarcode } from '@/services/foodApiService';
  ...
  if (!permission.granted) {
    return (
      <View style={styles.permissionContainer}>
        ...
        <Pressable style={styles.closeTextBtn} onPress={() => router.back()}>
...
const styles = StyleSheet.create({
  ...
  permissionTitle: {
    fontSize: 20, fontWeight: Fonts.bold, color: Colors.textPrimary, textAlign: 'center',
  },
  permissionSubtitle: {
  ...
  permissionBtnText: { color: Colors.textOnPrimary, fontWeight: Fonts.semibold, fontSize: 15 },
  closeTextBtn: { paddingVertical: Spacing.sm },
  closeTextBtnText: { color: Colors.textTertiary, fontSize: 14 },
  ...
  topTitle: { color: '#fff', fontSize: 17, fontWeight: Fonts.semibold },
  ...
  statusText: { color: '#fff', fontSize: 14, fontWeight: Fonts.medium },
  apiNote: {
    flexDirection: 'row', alignItems: 'center', gap: 5,
    paddingBottom: Platform.OS === 'ios' ? 40 : 24,
  },
  apiNoteText: { color: 'rgba(255,255,255,0.5)', fontSize: 12 },
});
